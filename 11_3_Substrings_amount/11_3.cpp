...
Входные данные
Единственная строка входного файла содержит строку s (1 ≤ |s| ≤ 400000). Строка состоит из строчных латинских букв.
...
int main() {
    ...
    int64_t sub_sum = str.size() - 1;
    sub_sum = (sub_sum * (sub_sum + 1)) / 2;
